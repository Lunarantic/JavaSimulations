...
public class Sim5_3 {
	...
	public static void main(String[] args) {
		...
		processes.add(new Process("P1", 0.0, 8.0, 8.0));
		processes.add(new Process("P2", 0.4, 4.0, 4.0));
		processes.add(new Process("P3", 1.0, 1.0, 1.0));
		...
		processes.add(new Process("P2", 0.4, 4.0, 4.0));
		processes.add(new Process("P3", 1.0, 1.0, 1.0));
		FileUtility.writeTotFile("Sim5_3.log", "Shortest Job First Serve with 1 sec delay" + "\n");
